const translations = {
  zh: {
    ...
    steam_open:"打开 Steam 商店页", steam_title:"在 Steam 上查看<br/>《拼豆！》", steam_fallback:"如果 Steam 小组件没有正常加载，也可以直接打开商店页面。", steam_badge:"愿望单 / 关注", steam_title_prominent:"在 Steam 上查看《拼豆！》", steam_desc_prominent:"把《拼豆！》加入愿望单，或直接打开 Steam 商店页查看最新信息。", tag_cozy:"轻松", tag_creative:"创作", tag_casual:"休闲", steam_metric_platform:"平台", steam_metric_status:"状态", steam_metric_status_val:"开发中", steam_open_main:"打开 Steam 商店页", steam_open_hint:"点击整张卡片即可跳转",
    catalog_kicker:"GAMES", catalog_title:"更多游戏", bottle_desc:"选择一个瓶盖，看它在水流与各种场景中和其他瓶盖比赛。轻松、物理模拟，也有一点完全交给运气的紧张感。", bottle_tag1:"休闲", bottle_tag2:"竞速", bottle_tag3:"物理", bottle_date:"2024 年 3 月 29 日", road_desc:"为了买一份海蜇出门，结果一路穿过沙雕大陆与多个次元。以好奇心、喜剧故事和冒险探索驱动的公路旅行。", road_tag1:"冒险", road_tag2:"角色扮演", road_tag3:"欢乐", road_tag4:"探索", road_date:"2019 年 10 月 30 日", released:"发行", features_kicker:"FEATURES", features_title:"舒服地摆，<br/>慢慢地完成。",
  ...
  en: {
    ...
    steam_open:"Open Steam store page", steam_title:"View PIN DOU!<br/>on Steam", steam_fallback:"If the Steam widget does not load, you can open the store page directly.", steam_badge:"Wishlist / Follow", steam_title_prominent:"View PIN DOU! on Steam", steam_desc_prominent:"Wishlist PIN DOU! or open the Steam store page to see the latest information.", tag_cozy:"COZY", tag_creative:"CREATIVE", tag_casual:"CASUAL", steam_metric_platform:"PLATFORM", steam_metric_status:"STATUS", steam_metric_status_val:"IN DEVELOPMENT", steam_open_main:"Open Steam store page", steam_open_hint:"Click anywhere on the card to open",
    catalog_kicker:"GAMES", catalog_title:"More games", bottle_desc:"Pick a bottle cap and watch it race through water-driven courses. A casual physics simulation where luck can still make every run tense.", bottle_tag1:"CASUAL", bottle_tag2:"RACING", bottle_tag3:"PHYSICS", bottle_date:"MAR 29, 2024", road_desc:"A trip to buy jellyfish turns into a journey across an absurd continent and multiple dimensions, driven by curiosity, comedy and exploration.", road_tag1:"ADVENTURE", road_tag2:"RPG", road_tag3:"FUNNY", road_tag4:"EXPLORATION", road_date:"OCT 30, 2019", released:"RELEASED", features_kicker:"FEATURES", features_title:"Settle in,<br/>place each bead.",
